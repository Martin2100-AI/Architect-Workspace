...
const TourRequestModel: typeof TourRequest = initTourRequestModel(sequelize);
const NotificationPreferenceModel: typeof NotificationPreference = initNotificationPreferenceModel(sequelize);
